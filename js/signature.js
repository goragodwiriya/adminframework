...
var SignaturePad = (function(document) {
  ...
  var SignaturePad = function(canvas, options) {
    ...
    this._canvas.addEvent('mousedown', function(event) {
      if (GEvent.isLeftClick(event)) {
        GEvent.stop(event);
    ...
    this._canvas.addEvent('mousemove', function(event) {
      GEvent.stop(event);
    ...
    this._canvas.addEvent('mouseup', function(event) {
      if (GEvent.isLeftClick(event) && self._mouseButtonDown) {
    ...
    this._canvas.addEvent('touchstart touchmove touchend', touchHandler, false);
    this.line = new Spline(this._canvas, options);
    this.clear();
  };
  ...
  SignaturePad.prototype.toDataURL = function(type, encoderOptions) {
    return this._isEmpty ? '' : this._canvas.toDataURL(type, encoderOptions);
  };

  SignaturePad.prototype.loadFromURL = function(imageSrc) {
    var image = new Image(),
